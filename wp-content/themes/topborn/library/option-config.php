		...
		**/
			...
			$this->sections[] = array(
				...
				'fields' => array (
					array (
						'id' => 'address',
						'type' => 'text',
						'title' => __('Address', 'brew-framework'),
						'default' => 'Hejsansvejsangatan 5, 123 45 Borås',
					),
					array (
						'id' => 'phonenumber',
						'type' => 'text',
						'title' => __('Phone number', 'brew-framework'),
						'default' => '070-123 45 67',
					),
					array (
						'id' => 'email',
						'type' => 'text',
						'title' => __('E-mail', 'brew-framework'),
						'default' => 'info@client.com',
					),
				),
			);
		...
		public function setArguments() {
			...
			$this->args = array(
				...
				'opt_name'          	=> 'topborn', // This is where your data is stored in the database and also becomes your global variable name.
				'display_name'			=> 'TB Options', // $theme->get('Name'), // Name that appears at the top of your panel
				'display_version'		=> '', //$theme->get('Version'), // Version that appears at the top of your panel
				'menu_type'          	=> 'menu', //Specify if the admin menu should appear or not. Options: menu or submenu (Under appearance only)
				'allow_sub_menu'     	=> true, // Show the sections below the admin menu item or not
				'menu_title'			=> __( 'TB Options', 'brew-framework' ),
	            'page'		 	 		=> __( 'TB Options', 'brew-framework' ),
	            ...
	            'page_slug'          	=> 'tb_options', // Page slug used to denote the panel
